...
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (1, 'kevin.m.bowersox@gmail.com', 'Kevin', 'Bowersox', 'password', 'kbowersox', 'ROLE_ADMIN');
...
insert into acl_sid (id, principal, sid) values (2, true, 'johndoe');
...
insert into  acl_class (1, 'com.oreilly.security.domain.entities.Appointment');
...
insert into acl_entry (acl_object_identity, ace_order, sid, mask, granting, audit_success, audit_failure)
		valeus (1, 1, 1, 1, true, true, true);
insert into acl_entry (acl_object_identity, ace_order, sid, mask, granting, audit_success, audit_failure)
		valeus (2, 1, 2, 1, true, true, true);